defmodule Slowcialsharing.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      # {Slowcialsharing.Worker, arg},
      # Start to serve requests, typically the last entry
      SlowcialsharingWeb.Endpoint
    ]

    # See https://hexdocs.pm/elixir/Supervisor.html
    # for other strategies and supported options
    opts = [strategy: :one_for_one, name: Slowcialsharing.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    SlowcialsharingWeb.Endpoint.config_change(changed, removed)
    :ok
  end
